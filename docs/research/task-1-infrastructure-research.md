...
|-----------|--------------|------|-------------|
| LLM | Gemini 3 Flash | $0.50/1M in, $3.00/1M out | Контекст 1M, баланс цена/качество |
...
| Критерий | Локальные (70B) | Облачные (Gemini 3 Flash) |
|----------|-----------------|---------------------------|
...
| Gemini 3 Flash | $15.00 | $22.50 | $37.50 |
...
| Компонент | Выбор | Характеристики | Цена/мес |
|-----------|-------|----------------|----------|
| LLM | Gemini 3 Flash | 1M context, MMLU 86% | $37.50 |
| Embeddings | Nomic v1.5 | 768 dim, MTEB 62.28 | $0 |
| Vector DB | ChromaDB | 2.58ms query | $0 |
...
|----|------------|---------|--------|
| BG-01 | TTFT < 3 сек | Gemini 3 Flash: 150-300ms | OK |
